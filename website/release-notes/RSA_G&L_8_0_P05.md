...
| **SF-02562773** | [ACM-126128](https://rsa.atlassian.net/browse/ACM-126128) | In certain instances, invalid role version entries were not removed, due to this user being unable to modify the role. As part of the solution, a scheduler is implemented to eliminate these invalid role versions. |
