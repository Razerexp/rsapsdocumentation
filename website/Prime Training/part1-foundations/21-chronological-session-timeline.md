...
## Part 1 — Morning/Afternoon Session (3h 19m)
...
| 0:20 – 0:35 | Technology stack | Java 8 / Tomcat 9 baseline; Java 17 / Tomcat 10 migration status (MS ready, SSP/HTAP pending); javax→jakarta refactoring history; PQC/crypto-provider swap question; symlink maintenance model; PrimeKit consolidation history (Justin) |
...
| 1:20 – 1:45 | Startup & validation | Manual service starts (MS/SSP/HTAP); ports 8443/8444/8445; Postman two-step flow (session token → user lookup); Activity Monitor verification; hardening guide and API reference guide discussion; documentation package commitment |
