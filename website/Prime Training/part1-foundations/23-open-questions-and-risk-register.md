...
| OQ-4 | SSP/HTAP Java 17 timeline — when do third-party library refactors land? | Stack discussion (Section 4.2) | MS ~2 weeks (Wells Fargo driver); SSP/HTAP unscheduled |
