...
# 30. Docker Containerization and the Prime Development Pipeline

## 30.1 Context: Why Now, and For Whom
...
## 30.2 The Container Topology

* **MS, SSP, and HDAP containers** — one per application, independently restartable.
...
* **HAProxy** — load balancing across application containers. Scaling is a one-file edit: modify the compose configuration, restart, and additional MS/SSP/HDAP nodes spin up (or down) 'in no time.'
