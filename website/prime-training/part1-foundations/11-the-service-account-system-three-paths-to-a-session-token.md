...
Standard token-credential authentication (PIN \+ tokencode), appropriate whenever a real human user with an authenticator is behind the call. This was the method used in the [Section 7](./7-service-startup-ports-and-api-validation.md) validation demo.
...
4. Create the Service Account Policy identity attribute definition (one of the three attributes Quick Setup pre-creates — see [Section 6.4](./6-installation-walkthrough-tarball-scripts-and-quick-setup.md)).
