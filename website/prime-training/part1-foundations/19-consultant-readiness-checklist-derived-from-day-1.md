---
title: "Consultant Readiness Checklist (Derived from Day 1)"
sidebar_position: 19
---
...
4. Start MS/SSP/HDAP; confirm ports 8443/8444/8445; validate with the two-step Postman flow (authenticate → user lookup); confirm the event in the AM Activity Monitor.
...
1. Demonstrate one adjacent suite capability the customer does not know it owns (HDAP delegation, ENS notifications, bulk invite).
