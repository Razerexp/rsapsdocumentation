...
# 18. Notable Q\&A and Discussion Highlights
...
## 18.2 Sessions, Clustering, and Load Balancers
...
## 18.4 Federal / Classified Delivery
...
## 18.5 Commercial and Engagement Strategy

* **On scoping the first SOCOM visit:** the customer knows only SSP exists; the team's plan is to install the full suite, deliver the WPI/password-checkout primary use case flawlessly, and then walk the customer through the other components ('are you interested in this, or HDAP, or…') — they own it all already; they simply don't have to use it yet.
