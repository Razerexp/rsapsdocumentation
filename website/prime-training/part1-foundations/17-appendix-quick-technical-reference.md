...
# 17. Appendix: Quick Technical Reference

## A. Component and Port Summary

| Component | Function | Port / Interface |
| :---- | :---- | :---- |
| AMIS | REST services engine; AM & CAS bridge; hub for all Prime components | 8443 (default) |
| SSP | End-user self-service portal (enrollment, token mgmt, password checkout) | 8444 (default) |
| HDAP | Help desk / delegated admin portal | 8445 (default) |
