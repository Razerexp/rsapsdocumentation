...
- WPI rotation: configure bulkupdate.properties and profile per [Section 15](./15-part-2-deep-dive-the-bulk-update-tool.md); encrypt credentials with Template Builder; test manually; schedule via Task Scheduler or cron.
