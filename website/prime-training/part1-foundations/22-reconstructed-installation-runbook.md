...
# 22. Reconstructed Installation Runbook
...
## 22.1 Stage 0 — Information Gathering (before touching any console)
...
## 22.2 Stage 1 — Authentication Manager Prerequisite
...
## 22.3 Stage 2 — Cloud Authentication Service Prerequisites
...
## 22.4 Stage 3 — Kit Extraction and Symlinks
...
## 22.6 Stage 5 — Post-Setup Verification in AM
...
## 22.7 Stage 6 — Start and Validate

1. Start services (as the primekit user in production): systemctl start \<tomcat-amis|ssp|hdap\> — or the \*\_startup.sh scripts, any order.

2. Confirm listeners: MS 8443, SSP 8444, HDAP 8445 (customize in the port configuration file only if required).
...
## 22.8 Stage 7 — Common Next Configurations (per engagement scope)
